...
parser.add_argument("--user", help="MQtt username.", default="homeassistant")
parser.add_argument("--password", help="MQtt password.", default="axiechee9Koli9vee8thingochoo3bieVien4Cahzohngoos2ohghoGhaehoovie")
...
parser.add_argument("--serial", help="Serial interface, default /dev/serial/by-id/usb-1a86_USB2.0-Serial-if00-port0",
                    default="/dev/serial/by-id/usb-1a86_USB2.0-Serial-if00-port0")
